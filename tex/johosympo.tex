...
\documentclass[base=10pt,magstyle=real,a4paper,twocolumn,xelatex,pandoc,jafont=ms]{bxjsarticle}%,jafont=ms
...
図の次行には図番および図題を設け，図番および図題の下は１行空ける(\figref{fig:figuresympo})。
...
表の幅は，段の幅82㎜以内または2段分の170mm以内とし，表の下は１行空ける（\tabref{tab:joho}）。
