...
\documentclass[base=8.8pt,magstyle=real,a4paper,twocolumn,xelatex,pandoc,jafont=ms]{bxjsarticle}
\usepackage{aijkibyoshi_xelatex}
...
\begin{center}
	...
	{\footnotesize
		\begin{tabular}{rl}
\mbox{*}&Prof., Dept. of Architecture, Faculty of Engineering, Kenchiku Institute of Technology, Dr. Eng\\
\mbox{**}&Research Assoc. Dept. of Architecture Faculty of Engineering Kenchiku Institute of Technology M. Eng.\\
\mbox{***}&Graduate Student Dept. of Architecture Faculty of Engineering Kenchiku Institute of Technology M. Eng.
		\end{tabular}
	}
	\vskip 1.5em
\end{center}
